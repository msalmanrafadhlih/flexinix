...

{
  services = {
    ...
    udev.extraRules = ''
      # Disable autosuspend for ROBOT KM3500 USB Receiver
      # `Bus 003 Device 004: ID 32c2:0066  2.4G Wireless`
      SUBSYSTEM=="usb", ATTRS{idVendor}=="32c2", ATTRS{idProduct}=="0066", ATTR{power/autosuspend}="-1"
    '';
